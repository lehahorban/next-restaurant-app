Цей проект є [Next.js](https://nextjs.org/) проектом, ініціалізованим за допомогою [`npx create-next-app@latest`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app).
